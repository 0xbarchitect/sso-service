...
const docTemplate = `{
    ...
    "info": {
        ...
        "title": "{{.Title}}",
        "termsOfService": "https://darenft.com/",
        "contact": {
            "name": "https://darenft.com/",
            "url": "https://darenft.com/",
            "email": "contact@darenft.com"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
        ...
        "/authorized/twitter": {
            "get": {
                ...
                "summary": "TwitterAuthorizedReq",
                "operationId": "TwitterAuthorizedReq",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
        ...
        "/get_presigned_url": {
            "post": {
                ...
                "summary": "GetS3PresignedURL",
                "operationId": "GetS3PresignedURL",
                "parameters": [
                    {
                        "description": "get s3 presigned url req body",
                        "name": "_",
                        "in": "body",
                        "schema": {
                            "$ref": "#/definitions/controllers.ReqGetS3PresignedURL"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "controllers.ReqGetS3PresignedURL": {
            "type": "object",
            "required": [
                "dareid",
                "filetype"
...
var SwaggerInfo = &swag.Spec{
	...
	Schemes:          []string{},
	Title:            "Dare SSO",
	Description:      "Dare SSO Core Service",
